...
text::text(SDL_Renderer* _renderer, const std::string &_font_path, SDL_Color _color, int _font_size, float _x, float _y, float _width, float _height, double _rotation)
{
